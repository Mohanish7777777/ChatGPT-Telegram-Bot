...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5857450134:AAGKX44tKt4L8BuQmUybo9d7C0KMGnW6nG0"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Mohanish Xadmin'
username = 'xadmin_chatgptbot'
